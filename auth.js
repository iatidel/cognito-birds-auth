var AUTH = (function(){
	...
	async function validateCredentials(){
		...
		AWS.config.credentials = new AWS.CognitoIdentityCredentials({
	    	...
	    	Logins : {
       		   "cognito-idp.us-east-1.amazonaws.com/us-east-1_1R5tR3Oee": token_str_or_null
       		}
		});
    	...
    	async function testDDBConnection(){
        	try {
        	    ...
        	    msg_str += 'Connecting to DynamoDB Table..'+params.TableName +'\r\n';
        	    msg_str += "Your Dynamodb Table"  + " has "+data['Count'] + " rows..";        	    
       	    	return msg_str
       		} catch (err) {
